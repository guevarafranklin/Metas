class UnidadsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to unidads_path, status: :see_other, notice: "Unidad was successfully destroyed." }
  ...
  private
    ...
    def set_unidad
      @unidad = Unidad.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def unidad_params
      params.expect(unidad: [ :name ])
    end
end
